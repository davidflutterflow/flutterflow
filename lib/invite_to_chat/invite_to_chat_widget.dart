...
class InviteToChatWidget extends StatefulWidget {
  const InviteToChatWidget({
    Key key,
    this.chat,
  }) : super(key: key);
  ...
  @override
  _InviteToChatWidgetState createState() => _InviteToChatWidgetState();
}

class _InviteToChatWidgetState extends State<InviteToChatWidget> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  FFLocalizations.of(context).getText(
                    '68pc4kql' /* Selectuser to add to chat. */,
                  ),
